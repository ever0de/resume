  ...
  work: (
    (
      ...
      body-ko: [
        ...
        - Rust 기반 Go 소스코드 자동 패치 CLI 도구 설계 및 개발. YAML 선언적 매니페스트와 tree-sitter AST 패턴 매칭으로 외부 의존성 수동 커스터마이징을 자동화.
      ],
      body-en: [
        ...
        - #link(
            "https://github.com/ever0de/resume/tree/9bd13a2/public/newmetric/cache",
          )[Converted a non-horizontally-scalable single-node architecture into a horizontally scalable one, achieving 17.5× throughput improvement over prior implementation on identical hardware (≈140k ops/s, p90 26.1ms under production spike-pattern traffic).]
        ...
        - Designed and built govld, a Rust CLI for automated Go source patching. Declarative YAML manifests with tree-sitter AST pattern matching automated manual dependency customization.
      ],
    ),
    (
      title-ko: "소프트웨어 엔지니어",
